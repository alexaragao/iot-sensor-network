...
// WIFI
const char* SSID = "WESTEROS"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "wiowiozedas"; // Senha da rede WI-FI que deseja se conectar
  
// MQTT
// const char* BROKER_MQTT = "iot.eclipse.org"; //URL do broker MQTT que se deseja utilizar
const char* BROKER_MQTT = "10.0.1.6"; //URL do broker MQTT que se deseja utilizar
